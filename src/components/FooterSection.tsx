      ...
      <ul className="grid grid-cols-2">
        ...
        <li className="py-8 space-y-2">
          ...
          <ul className="space-y-1">
            <li className="text-sm transition text-neutral-500 hover:text-neutral-900 font-light">
            ...
            <li className="text-sm text-neutral-500 font-light">
              <span className="cursor-not-allowed">نسخه اندروید (به زودی)</span>
            </li>
          </ul>
        </li>
      </ul>
      <p className="py-4 border-t border-slate-200 flex items-center justify-between text-xs font-light">
